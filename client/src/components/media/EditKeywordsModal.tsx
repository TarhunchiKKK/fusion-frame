...
export function EditKeywordsModal({ close, media, editKeywords }: EditKeywordsModalProps){
    ...
    return(
        <>
            ...
            <div className="flex flex-col justify-between w-2/5 h-1/5 mx-auto mt-2 mb-4 p-5 
                ...
                <div className="mx-auto w-11/12 mb-2">
                    <form action="" onSubmit={submitHandler}>
                        <input type="text" value={media.keywords.join('; ')} onChange={changeHandler} className="border rounded-xl w-full h-10 outline-0" placeholder="Ключевые слова через ';'" />
                    </form>
                </div>
            </div>
        </>
